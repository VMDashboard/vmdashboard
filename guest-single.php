        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-sm-3">
              ...
              <?php  if ($state == "shutoff") { ?>
                <a class="domain-delete" onclick='swal({ title:"Good job!", text: "You clicked the button!", type: "warning", showCancelButton: true"})' href="?action=domain-delete&amp;uuid=<?php echo $uuid; ?>" target="_self" >
